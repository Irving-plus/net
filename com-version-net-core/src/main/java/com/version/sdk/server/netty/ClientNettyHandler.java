...
//		LoggerUtil.debug("Server  sessionClosed: {}", session);
		//SuperClient superClient = ServerSessionManager.getManager().findClientBySession(session.channel());
		//close(superClient);
	}
	...
	private void close(SuperClient superClient) throws Exception {
